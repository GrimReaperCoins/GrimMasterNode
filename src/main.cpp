...
int64_t GetProofOfStakeReward(int nHeight, const CBlockIndex* pindexPrev, int64_t nCoinAge, int64_t nFees)
{
    ...
    if (nHeight < 200)
        nSubsidy = 0;
	else if (nHeight < 3500 && nHeight >= 200) 
		nSubsidy = 1; 
	else if (nHeight < 125000  && nHeight >= 3500) 
		nSubsidy = STATIC_POS_REWARD; 						
	else if (nHeight < 250000  && nHeight >= 125000) 
		nSubsidy = STATIC_POS_REWARD * 0.5; 			
	else if (nHeight < 375000  && nHeight >= 250000) 
		...
		nSubsidy = STATIC_POS_REWARD * 0.0625; 				
	else														
		nSubsidy = 10;					
