    ...
    ui(new Ui::AddEditAdrenalineNode)
{
    ...
    //Labels
    ui->aliasLineEdit->setPlaceholderText("Enter your Grimnode alias");
    ui->addressLineEdit->setPlaceholderText("Enter your IP & port");
    ui->privkeyLineEdit->setPlaceholderText("Enter your Grimnode private key");
    ui->txhashLineEdit->setPlaceholderText("Enter your 175000 GRIM TXID");
