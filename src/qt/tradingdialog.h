...
private slots:
    ...
    QString BuyGRIM(QString OrderType, double Quantity, double Rate);
    QString SellGRIM(QString OrderType, double Quantity, double Rate);
