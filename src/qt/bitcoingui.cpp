...
#endif
	setObjectName("Grim");
	setStyleSheet("#Grim { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #ffffff, stop: 1 #ffffff);  }");
	// Accept D&D of URIs
	setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
	...
	overviewAction = new QAction(QIcon(":/icons/1dashboard"), tr("&Dashboard"), this);
	overviewAction->setToolTip(tr("Show general overview of wallet"));
	overviewAction->setCheckable(true);
	overviewAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_1));
	tabGroup->addAction(overviewAction);

	receiveCoinsAction = new QAction(QIcon(":/icons/3receive"), tr("&Receive"), this);
	receiveCoinsAction->setToolTip(tr("Show the list of addresses for receiving payments"));
	receiveCoinsAction->setCheckable(true);
	receiveCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
	tabGroup->addAction(receiveCoinsAction);

	sendCoinsAction = new QAction(QIcon(":/icons/2send"), tr("&Send"), this);
	sendCoinsAction->setToolTip(tr("Send coins to a Grim address"));
	sendCoinsAction->setCheckable(true);
	sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_3));
	tabGroup->addAction(sendCoinsAction);

	historyAction = new QAction(QIcon(":/icons/4transactions"), tr("&Transactions"), this);
	historyAction->setToolTip(tr("Browse transaction history"));
	historyAction->setCheckable(true);
	historyAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_4));
	tabGroup->addAction(historyAction);

	addressBookAction = new QAction(QIcon(":/icons/5addresses"), tr("&Addresses"), this);
	addressBookAction->setToolTip(tr("Edit the list of stored addresses and labels"));
	addressBookAction->setCheckable(true);
	addressBookAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_5));
	tabGroup->addAction(addressBookAction);

	masternodeManagerAction = new QAction(QIcon(":/icons/6grimnodes"), tr("&Grimnodes"), this);
	masternodeManagerAction->setToolTip(tr("Show Grimnodes status and configure your own Grimnode."));
	masternodeManagerAction->setCheckable(true);
	tabGroup->addAction(masternodeManagerAction);

	messageAction = new QAction(QIcon(":/icons/7messages"), tr("&Messages"), this);
	messageAction->setToolTip(tr("View and Send Encrypted messages"));
	messageAction->setCheckable(true);
	tabGroup->addAction(messageAction);

	blockAction = new QAction(QIcon(":/icons/8explorer"), tr("&Block Explorer"), this);
	...
	quitAction->setMenuRole(QAction::QuitRole);
    	...
    	pioAction = new QAction(tr("&Grim Website"), this);
	pioAction->setToolTip(tr("Visit the Official Grim website"));
	...
	bitcointalkAction->setToolTip(tr("Visit our Bitcointalk discussion thread"));
    	...
    	chainAction = new QAction(tr("&Grim Discord"), this);
    	chainAction->setToolTip(tr("Join Grim Discord"));

    	explorerAction = new QAction(tr("&Grim Explorer"), this);
	explorerAction->setToolTip(tr("Grim Explorer"));
...
void BitcoinGUI::createToolBars()
{
	...
	toolbar->setStyleSheet("QToolButton { color: #ffffff; font-size: 13px; font-weight: 700; font-family: 'Helvetica'; padding: 5px; padding-left: 8px; border: none; }"
		"QToolButton:hover { background-color: #ED0000; color: #ffffff; font-size: 13px; font-weight: 700; font-family: 'Helvetica'; border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:checked { background-color: #ED0000; color: #ffffff; font-size: 13px; font-weight: 700; font-family: 'Helvetica';  border: none; padding-top: 5px; padding-bottom: 5px; }"
		"QToolButton:pressed { background-color: #ED0000; color: #ffffff; font-size: 13px; font-weight: 700; font-family: 'Helvetica'; border: none; padding-top: 5px; padding-bottom: 5px; }"
...
{
    QDesktopServices::openUrl(QUrl("https://reaper.rocks"));
}

void BitcoinGUI::bitcointalkClicked()
{
    QDesktopServices::openUrl(QUrl("https://bitcointalk.org/index.php?topic=2278351"));
}

void BitcoinGUI::chainClicked()
{
    QDesktopServices::openUrl(QUrl("https://discord.gg/rDsFZaS"));
}
void BitcoinGUI::explorerClicked()
{
    QDesktopServices::openUrl(QUrl("https://explorer.reaper.rocks"));
}
