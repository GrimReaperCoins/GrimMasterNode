...
boost::filesystem::path GetDefaultDataDir()
{
    ...
    // Windows < Vista: C:\Documents and Settings\Username\Application Data\GrimMN
    // Windows >= Vista: C:\Users\Username\AppData\Roaming\GrimMN
    // Mac: ~/Library/Application Support/GrimMN
    // Unix: ~/.GrimMN
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "GrimMN";
#else
    fs::path pathRet;
